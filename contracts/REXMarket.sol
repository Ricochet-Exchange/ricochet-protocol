...
contract REXMarket is Ownable, SuperAppBase, Initializable {
  ...
  Market market;
  IREXReferral referral;                // REX Referral contract
  ...
  constructor(address _owner, ISuperfluid _host, IConstantFlowAgreementV1 _cfa, IInstantDistributionAgreementV1 _ida, IREXReferral _referral) public {
    host = _host;
    cfa = _cfa;
    ida = _ida;
    referral = _referral;
