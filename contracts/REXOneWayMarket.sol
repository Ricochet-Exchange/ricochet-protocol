...
contract REXOneWayMarket is REXMarket {
    ...
    uint32 public constant OUTPUT_INDEX = 0;
    ...
    function initializeOneWayMarket(
        ...
        ERC20(address(market.outputPools[OUTPUT_INDEX].token))
        ...
        returns (bytes memory newCtx)
    {
        ...
        uint256 feeCollected = (actualAmount *
            market.outputPools[OUTPUT_INDEX].feeRate) / 1e6;
