...
async function main() {
    ...
    let inputTokenAddress = config.DAIX_ADDRESS;
    let inputTokenUnderlyingAddress = config.DAI_ADDRESS;
    let outputTokenAddress = config.USDCX_ADDRESS;
    let outputTokenUnderlyingAddress = config.USDC_ADDRESS;
