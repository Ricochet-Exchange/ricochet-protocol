...
describe('REXTwoWayMarket', () => {
  ...
  describe('Stream Exchange', async () => {
    ...
    xit('should distribute tokens to streamers', async () => {
      ...
      await usdcx.transfer(u.alice.address, toWad(400), { from: u.usdcSpender.address });
      console.log('Transfer bob');
      await ethx.transfer(u.bob.address, toWad(400), { from: u.ethSpender.address });
      console.log('Done');
    ...
    xit('should distribute tokens to streamers correctly', async () => {
      ...
      console.log('Transfer bob');
      await usdcx.transfer(u.bob.address, toWad(400), { from: u.usdcSpender.address });
      console.log('Transfer alice');
      await usdcx.transfer(u.alice.address, toWad(400), { from: u.usdcSpender.address });
      console.log('Transfer admin');
      await usdcx.transfer(u.admin.address, toWad(400), { from: u.usdcSpender.address });
      console.log('Done');
